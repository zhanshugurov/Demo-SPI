...
export default function Header() {
  ...
  return (
    <header className="flex flex-col rounded-2xl sm:flex-row justify-between items-start sm:items-center bg-white/80 backdrop-blur border-b border-gray-200 px-6 py-3 sticky top-0 z-10 shadow-sm transition-all gap-3 sm:gap-0">
      {/* Левая часть */}
